...
public class PedeDadoQuadrado extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pede_dado_quadrado);
    }
    ...
    public void ProximaJanela (View quemclicou){
        ...
        Double Resposta= dado*dado2;

        Bundle mochilaCirculo = new Bundle();
        mochilaCirculo.putDouble("Resposta",Resposta);

        Intent intencao = new Intent(getApplicationContext(), RespostaQuadrado.class);
